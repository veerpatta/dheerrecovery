...
export function NavTabs() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 mx-auto flex w-full max-w-[var(--shell-width)] border-t border-line bg-white/96 px-1.5 pt-1.5 pb-[calc(0.5rem+env(safe-area-inset-bottom))] backdrop-blur no-print">
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            <span
              className={`flex rounded-full px-[15px] py-1 transition-colors ${
